...
module.exports = {
    ...
    start: async(naisa, m, { text }) => {
        if (text) {
            ...
            naisa.sendFile(m.from, "https://i.pinimg.com/originals/a6/81/c5/a681c55ca1bee611c39d3b4a58712dc3.jpg", "", m, { caption: teks })
        } else if (!text) {
            const sections = [{
                title: "Kisah Nabi",
                rows: [
            ...
            const sendMsg = await naisa.sendMessage(m.from, listMessage, { quoted: m })
        }
    }
}